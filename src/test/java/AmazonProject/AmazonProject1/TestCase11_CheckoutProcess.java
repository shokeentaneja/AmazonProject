...
public class TestCase11_CheckoutProcess extends BaseClass
{
	...
	public void ProductDetails() throws InterruptedException, EncryptedDocumentException, IOException
	{
		...
		checkout.creditDebitCard();
		checkout.cardDetails();
		checkout.masterCardDetails();
		checkout.nickNameOfCardHolder();
		checkout.dateSelection();
		checkout.yearSelection();
		checkout.cardDetailsContinueButton();
